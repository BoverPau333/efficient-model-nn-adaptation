...
def _tensor_to_displayable_image(img_tensor):
    ...
    Assumes ImageNet normalization used in your script.
    """
    ...
    # If grayscale expanded to 3 channels, this still works.
    if img.shape[0] == 3:
        img = img * std + mean
...
def plot_confusions(dataset, indices_a_to_b, indices_b_to_a,
                    classes, class_a, class_b, num_samples=5):
    """
...
def visualize_confusion_pair(model, test_loader, test_dataset,
                             classes, class_a_name, class_b_name,
    ...
    plot_confusions(
        test_dataset, a_to_b, b_to_a,
        classes, class_a, class_b,
        num_samples=num_samples
    )


def visualize_top_confused_pairs(model, test_loader, test_dataset,
                                 classes, cm, device,
                                 top_k=5, num_samples=5):
    """
